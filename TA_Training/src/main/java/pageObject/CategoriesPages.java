...
public class CategoriesPages {
	...
	public void click_Product2(Informations informations) {
		WebElement product = driver.findElement(By.cssSelector("[title='" + informations.product2 + "'] [title='" + informations.product2 + "']"));
		WebElement viev = driver.findElement(By.xpath("//a[@title='" + informations.product2 + "']//following-sibling::a"));
		Actions action = new Actions(driver);
	...
	public void click_Product3(Informations informations) {
		WebElement product = driver.findElement(By.cssSelector("[title='" + informations.product3 + "'] [title='" + informations.product3 + "']"));
		WebElement viev = driver.findElement(By.xpath("//a[@title='" + informations.product3 + "']//following-sibling::a"));
		Actions action = new Actions(driver);
		action.moveToElement(product).moveToElement(viev).click().build().perform();
		Wait.until(driver, ExpectedConditions
				.invisibilityOfElementLocated(By.xpath("//div[@class='fancybox-overlay fancybox-overlay-fixed']")));
